...
@Component(label = Dash.PREFIX + " " + MiscAdminProvider.LABEL, description = "Provides links which targets to misc admin", policy = ConfigurationPolicy.OPTIONAL, immediate = true, metatype = true)
@Service(Provider.class)
@Properties({ @Property(name = Constants.SERVICE_VENDOR, value = Dash.SERVICE_VENDOR) })
public class MiscAdminProvider implements Provider {

	private static final Logger LOG = LoggerFactory.getLogger(MiscAdminProvider.class);

	public static final String LABEL = "Finder Misc Admin Provider";

	private static final String ADMIN_PATH = "/miscadmin#%s";
	...
	private static final int RESULT_RANK_DEFAULT = 250;
	...
	private static final String CONTENT_ROOT_DEFAULT = "/etc";
